Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: "http://earlybirds-co-za.herokuapp.com" }
  ...
  # config.action_mailer.asset_host = ENV.fetch('DIGITAL_OCEAN_SPACES_CDN_URL')
  ...
  # config.active_job.queue_name_prefix = "Rails_React_Native_Demo_#{Rails.env}"
